...
def welcome():
    ...
    return (
        ...
        f"List Stations: /api/v1.0/stations<br/>"
        f"Temperature for one year: /api/v1.0/tobs<br/>"
        f"Temperature stat from the start date to end dates(yyyy-mm-dd): /api/v1.0/yyyy-mm-dd<br/>"
    )
...
def tobs():
    ...
    for date, tobs in queryresult:
        ...
        tobs_dict["Date"] = date
        tobs_dict["Tobs"] = tobs
        toall.append(tobs_dict)

    return jsonify(toall)
